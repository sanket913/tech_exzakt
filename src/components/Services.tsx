...
import { Globe, Palette, FileText, Package, CreditCard, Settings, ArrowRight, Check, Star, Zap, Clock, Users, Crown } from 'lucide-react';
    ...
    <section id="services" className="py-16 sm:py-20 lg:py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <div className="inline-flex items-center space-x-2 premium-card rounded-full px-4 py-2 mb-6">
            <Star className="w-4 h-4 text-yellow-400" />
            <span className="text-white font-medium text-sm font-heading">Our Services</span>
          </div>
          
          <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-4 sm:mb-6 font-heading">
            Transform Your
            <span className="block premium-gradient-text premium-text-glow bg-clip-text text-transparent">
              Digital Presence
            </span>
          </h2>
        </div>
        ...
        <div className="md:grid md:grid-cols-2 xl:grid-cols-3 md:gap-6 lg:gap-8">
                ...
                >
                  ...
                  {service.popular && (
                    <div className="absolute -top-3 left-6 z-20">
                      <div className="premium-gradient text-black px-4 py-1 rounded-full text-xs font-bold font-body flex items-center space-x-1 uppercase tracking-wider">
                  ...
                  {/* Service Card */}
                  <div className={`relative h-full premium-card rounded-3xl p-6 sm:p-8 transition-all duration-500 hover:scale-105 ${
                      hoveredService === index 
                        ? `${service.borderColor} premium-glow` 
                    ...
                    <div className="flex items-start justify-between mb-6">
                      <div className={`w-14 h-14 bg-gradient-to-br ${service.color} rounded-2xl flex items-center justify-center transition-transform duration-300 shadow-lg ${
                    hoveredService === index ? 'scale-110 rotate-6' : 'group-hover:scale-105'}`}>
                      ...
                      <div className="text-right">
                        <div className="flex items-center justify-end space-x-1 mb-1">
                          ...
                          <span className="text-gray-400 text-xs font-medium font-body">{service.timeline}</span>
                        </div>
                        <div className="flex items-center justify-end space-x-1">
                          <Users className="w-3 h-3 text-yellow-400" />
                          <span className="text-yellow-400 text-xs font-medium font-body">{service.expertise}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4 mb-6">
                      ...
                      <p className="text-gray-400 text-sm leading-relaxed font-body pt-2 border-t border-gray-800">
                        {service.description}
                      </p>
                    </div>
                    ...
                    <div className="space-y-2 mb-6">
                      <h4 className="text-white font-semibold text-sm font-heading mb-3 uppercase tracking-wider">Key Features:</h4>
                    ...
                    <button 
                      ...
                      className={`w-full bg-gradient-to-r ${service.color} text-black py-3 sm:py-4 px-6 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center space-x-2 group/btn font-body hover:shadow-lg transform hover:scale-105 uppercase tracking-wider text-sm`}
                    >
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              {service.popular && (
                <div className="absolute -top-3 left-6 z-20">
                  <div className="premium-gradient text-black px-4 py-1 rounded-full text-xs font-bold font-heading flex items-center space-x-1">
              ...
              <div className={`relative h-full premium-card rounded-3xl p-6 sm:p-8 transition-all duration-500 hover:scale-105 ${
                ...
                <div className="flex items-start justify-between mb-6">
                  <div className={`w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br ${service.color} rounded-2xl flex items-center justify-center transition-transform duration-300 ${
                    ...
                    <service.icon className="w-7 h-7 sm:w-8 sm:h-8 text-black" />
                  </div>
