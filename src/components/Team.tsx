    ...
    <section id="team" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
              ...
              <div className="premium-card backdrop-blur-xl border border-gray-700/50 rounded-3xl p-8 hover:border-yellow-500/30 transition-all duration-500">
                <div className="flex items-start space-x-6">
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-slate-700 group-hover:border-yellow-500/50 transition-colors duration-300">
                      <img 
                        src={member.image} 
                        alt={member.name}
                    ...
                    <div className="absolute -bottom-2 -right-2 w-8 h-8 premium-gradient rounded-lg flex items-center justify-center">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {member.skills.map((skill, skillIndex) => (
                        <span key={skillIndex} className="text-xs text-slate-300 bg-gray-800/50 px-3 py-1 rounded-full border border-slate-700">
                          {skill}
                        </span>
                      ))}
                    </div>
        ...
        <div className="text-center">
          <div className="premium-card backdrop-blur-xl border border-gray-700/50 rounded-3xl p-8 max-w-4xl mx-auto">
