...
const Portfolio: React.FC = () => {
  ...
  return (
    <section id="portfolio" className="py-16 sm:py-20 lg:py-24 relative overflow-hidden">
      ...
      {/* MODAL */}
      {selectedProject && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 lg:p-8 pt-24 sm:pt-28 lg:pt-32">
          <div className="absolute inset-0 bg-black/70 backdrop-blur-sm" onClick={closeProjectModal}></div>

          <div className="relative w-full max-w-4xl max-h-[90vh] bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl">
            {/* Modal Header */}
            <div className="flex justify-between items-center p-4 sm:p-6 border-b border-slate-700/50 bg-slate-800/50">
              <div className="flex items-center space-x-3">
                <div className={`w-3 h-3 rounded-full bg-gradient-to-r ${selectedProject.color}`}></div>
                <div>
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white font-heading">{selectedProject.title}</h3>
                  <p className="text-sm text-cyan-400 font-medium">{selectedProject.category}</p>
                </div>
              </div>
              <button 
                onClick={closeProjectModal} 
                className="w-8 h-8 sm:w-10 sm:h-10 bg-slate-800/50 hover:bg-slate-700/50 rounded-full flex items-center justify-center text-slate-400 hover:text-white transition-all duration-300"
              >
                ...
                <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300 leading-relaxed text-sm sm:text-base font-body">{selectedProject.description}</p>
                    </div>
                  ...
                  <div className="lg:col-span-1 space-y-6">
                    ...
                    <div className="bg-slate-800/30 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-slate-700/30">
                      ...
                      <div className="space-y-4">
                        <div>
                          <div className="text-slate-400 text-xs font-medium mb-1">Category</div>
                        ...
                        <div>
                          <div className="text-slate-400 text-xs font-medium mb-1">Theme</div>
                          <div className="flex items-center space-x-2">
                            <div className={`w-4 h-4 rounded-full bg-gradient-to-r ${selectedProject.color}`}></div>
